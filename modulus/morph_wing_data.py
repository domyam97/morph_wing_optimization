...
def load_data(res_path, csv_name, n_train=50, n_test=10):
    ...
    for i in range(n_train):
        ...
        nuT_train = np.concatenate((nuT_train,vtk_obj.get_array("nuTilda")*len_scale*time_scale/mass_scale),axis = 0)
...
@modulus.sym.main(config_path="conf", config_name="conf_data.yaml")
def run(cfg: ModulusConfig) -> None:
    ...
    data = load_data(res_path, csv_name, 70,30)
    ...
    cfg.initialization_network_dir = os.path.expandvars("${SCRATCH}/modulus/outputs/morph-wing_data")
    cfg.network_dir = os.path.expandvars("${SCRATCH}/modulus/outputs/morph-wing_data")
