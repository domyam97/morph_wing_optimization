...
def run(cfg: ModulusConfig) -> None:
    ...
    csv_name = 'morph-wing_dataset_single.csv'
    res_path = os.path.expandvars('${GROUP_HOME}/${USER}/vtk_res')
    data, scale = load_data(res_path, csv_name, 20,5)
    ...
    cfg.initialization_network_dir = os.path.expandvars("${SCRATCH}/modulus/outputs/morph-wing_single_case")
    cfg.network_dir = os.path.expandvars("${SCRATCH}/modulus/outputs/morph-wing_single_case")
